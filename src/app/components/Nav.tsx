...
export default function Nav() {
  ...
  return (
    <nav>
      ...
      <ul className={`${menu ? 'opacity-100 duration-700' : 'max-[640px]:opacity-0 right-[-100%] duration-700'} max-[640px]:h-[calc(70vh_-_4rem)] max-[640px]:rounded flex flex-col w-[70%] bg-slate-700 absolute top-14 z-50 right-0 p-4 gap-3 sm:flex-row sm:static sm:p-0 text-white`}>
        <li >
          <ActiveLink href='/'>
            Home
          </ActiveLink>
